...
//        $marketplace = isset($params['marketplace']) ? $params['marketplace'] : false;
//        if(isset($params['marketplace'])){
//            $conditionalQuery["settings.".$params['marketplace']] = ['$exists' => true];
//        }
        $aggregation = [
            [
                '$project' => [
                ...
                foreach ($optionAttributes as $optionValue) {
                    if (isset($varProds[$optionValue])) {
                        ...
                        if ($isJson !== false) {
                            ...
                            foreach ($decodedData as $optKey => $optValue) {
    ...
    public function makeEntryInMarketplaceTable($productId, $marketplace, $productCreated)
    {
    ...
    public function getMatchingProfiles($profileDetails)
    {
        ...
        $aggregation = [
                        ...
                        /*"sourceShop" => isset($profileDetails['source_shop']) ? $profileDetails['source_shop'] : '',*/
...
//            $marketplace = $response['source'];
//            $sourceShop = $response['sourceShop'];
            $sourceShop = false;
            $data = [
