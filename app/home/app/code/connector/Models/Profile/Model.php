    ...
    public function createUpdateProfile($data,$overWriteExistingProducts=true)
    {
    	...
    	if(isset($data['category_id'],$data['name']))
        {
            ...
            if($this->save()){
                ...
                //Start save profile id in the conatainer
...
*/
                       ...
                       /*$collection->updateMany($customizedFilterQuery,['$set'=>['profile'=>true]]);*/
                      // $collection->updateMany($customizedFilterQuery,['$unset'=>['profile'=>null]]);
                    }
                }
                //end save
