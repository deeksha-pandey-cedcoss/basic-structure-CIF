...
class FeedProductsHalfYearly extends \App\Core\Components\Services
{
    ...
    public function getDescription($plan)
    {
        ...
        $priceText = 'for free';
        if ($price > 0) {
            $priceText = 'at only ' . $price . '$ half-yearly';
        }
        $description = 'You can generate feeds of upto ' . $maxProducts . ' products ' . $priceText . ' and upload them to your merchant center.';
