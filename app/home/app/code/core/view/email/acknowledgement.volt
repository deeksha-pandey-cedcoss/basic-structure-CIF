...
<center>
  ...
  <div style="margin-top: 2%;display: block;">
    <table width="50%" border="0" cellpadding="0" cellspacing="8" >
      ...
      <tr>
        <td align="left" style="padding-top: 1%;font-size: 110%;font-family: Times New Roman;line-height: 140%;" colspan="4">
          We have recieved your complaint. We're sorry that you are having this problem and Thank you for bringing this matter to our attention . 
        </td>
      </tr>
        <tr>
        <td align="left" style="padding-top: 1%;font-size: 110%;font-family: Times New Roman;line-height: 140%;" colspan="4">
         Now that We are aware of the situation, We will definitely fix it for you and will get back to you with a solution as soon as we can.
        </td>
      </tr>
      <tr>
        <td align="left" style="padding-top: 2%;font-size: 110%;font-family: Times New Roman;font-weight: bold;" colspan="2">
          Below are just the details of the Issue generated by you
        </td>
      </tr>
    </table>
  </div>
      ...
      <tr style="font-size: 110%">
        <td width="100%"><div style="display: block;font-size: 15px">
            <table width="100%" border="0" cellpadding="0" cellspacing="8" >
               <tr>
                <td align="left" style="padding-top: 1%;font-size: 120%;font-weight:bold;font-family: Times New Roman" colspan="4">
                    Title
                </td>
                <td align="left" style="padding-top: 1%;font-size: 100%;font-family: Times New Roman" colspan="4">
                    {{title}}
                </td>
              </tr>
               <tr>
