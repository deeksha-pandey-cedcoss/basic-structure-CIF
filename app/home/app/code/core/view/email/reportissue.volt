          ...
          <td align="center" bgcolor="#fafafa" style="padding: 15px 15px 15px 15px;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left">
                  <font face="'Open Sans', Arial, Helvetica, sans-serif;">
                    <span style="color: #333333;font-size: 24px;">Dear Admin,</span>
                  </font>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left">
                  <font face="'Open Sans', Arial, Helvetica, sans-serif;">
                    <span style="color: #000000;font-size: 16px;">                                               {{ text }} </span>
                  </font>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left">
                  <font face="'Open Sans', Arial, Helvetica, sans-serif;">
                    <span style="color: #6DCC00;font-size: 14px;">                                               Please get a solution for this issue as soon as possible. Thank you. </span>
                  </font>
                </td>
              </tr>
              <tr>
