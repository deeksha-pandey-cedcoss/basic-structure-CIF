          ...
          <td align="center" bgcolor="#fafafa" style="padding: 15px 15px 15px 15px;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left">
                  <font face="'Open Sans', Arial, Helvetica, sans-serif;">
                    <span style="color: #000000;font-size: 16px;">                                               Greetings from CedCommerce!
 </span>
                  </font>
                </td>
              </tr>
              ...
              <tr>
                <td align="left">
                  <font face="'Open Sans', Arial, Helvetica, sans-serif;">
                    <span style="color: #000000;font-size: 16px;">                                               Welcome to the {{app}} app. We are happy to see you as a part of this steady and robust integration feature. </span>
                  </font>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left">
                  <font face="'Open Sans', Arial, Helvetica, sans-serif;">
                    ...
                    If you have any queries about our app then you can feel free to contact us anytime. We are available 24X7 to assist you. </span>
                  </font>
                </td>
              </tr>
              <tr>
