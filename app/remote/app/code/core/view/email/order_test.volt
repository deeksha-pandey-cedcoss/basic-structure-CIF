...
<center>
  ...
  <div style="margin-top: 2%;display: block;">
    <table width="50%" border="0" cellpadding="0" cellspacing="8" >
      <tr>
        <td align="left" style="padding-top: 1%;font-size: 150%;color:#6e7072;font-weight:bold;font-family: Times New Roman" colspan="4">
          Hi {{ username }}
        </td>
      </tr>
      <tr>
        <td align="left" style="padding-top: 1%;font-size: 110%;color:#6e7072;font-family: Times New Roman" colspan="4">
          Congratulations !!! You have recieved a new Order,Here is summary of your order
        </td>
      </tr>
      <tr>
        <td align="left" style="padding-top: 1%;font-size: 110%;color:#6e7072;font-family: Times New Roman;font-weight: bold;" colspan="2">
          {{ marketplace }} Order Id
        </td>
        <td align="left" style="padding-top: 1%;font-size: 110%;color:#6e7072;font-family: Times New Roman" colspan="2">
