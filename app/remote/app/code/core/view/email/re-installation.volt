            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left">
                  <font face="'Open Sans', Arial, Helvetica, sans-serif;">
                    ...
                    Thank you for re-installing {{app}}. </span>
                  </font>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left">
                  <font face="'Open Sans', Arial, Helvetica, sans-serif;">
                    <span style="color: #000000;font-size: 16px;">  
                    It’s a great pleasure for us to see you again on the {{app}} app. We applaud your decision to reinstall the app and reconnect with us. </span>
                  </font>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left">
                  <font face="'Open Sans', Arial, Helvetica, sans-serif;">
                    <span style="color: #000000;font-size: 16px;">  
                    Thank you for showing faith in us and we hope to have an everlasting relationship with you. </span>
                  </font>
                </td>
              </tr>
              <tr>
